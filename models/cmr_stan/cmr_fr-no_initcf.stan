functions {
    real cmr_lpmf(int[] recall_sequence, int LL, real init_fc, real beta_enc, real beta_rec, real beta_start, real P1, real P2, real stopInit, real stopScale, real stopShape, real gamma) {
    ...
    int[] cmr_rng(int LL, real init_fc, real beta_enc, real beta_rec, real beta_start, real P1, real P2, real stopInit, real stopScale, real stopShape, real gamma) {
        int num_context_units = LL + 1;
        int num_item_units = LL;
        int start_index = LL + 1;
...
transformed parameters {
...

    {
        ...
        subjPars[7] = inv_logit(parMean[7] + subjParsR[7]);
...
model {
    ...
    for (i in 1:nSeq) {
        recall_sequences[i] ~ cmr(LL[i], subjPars[1, subj[i]], subjPars[2, subj[i]], subjPars[3, subj[i]], subjPars[4, subj[i]], subjPars[5, subj[i]], subjPars[6, subj[i]], subjPars[7, subj[i]], subjPars[8, subj[i]], subjPars[9, subj[i]], subjPars[10, subj[i]]);
    }
}
generated quantities {
    ...
    for (i in 1:nSeq) {
        pred_recall[i] = cmr_rng(LL[i], subjPars[1, subj[i]], subjPars[2, subj[i]], subjPars[3, subj[i]], subjPars[4, subj[i]], subjPars[5, subj[i]], subjPars[6, subj[i]], subjPars[7, subj[i]], subjPars[8, subj[i]], subjPars[9, subj[i]], subjPars[10, subj[i]]);
    }
}
